const skillsBento = [
    ...
    },
    {
      ...
      skills: ["HTML5", "CSS3, Tailwind CSS", "JavaScript", "React", "JQuery", "Thymeleaf", "Bootstrap"],
      area: "web-technologies"
    },
    {
      title: "Programming Languages",
      skills: ["Java", "Python (Matplotlib, NumPy, PyGame libraries)", "JS", "C# (.NET Core, ASP.NET)", "C++", "Kotlin", "R"],
    ...
    },
    {
      ...
      skills: ["Information Technology Specialist in Python Certification", "Information Technology Specialist in Databases Certification"],
      area: "certifications"
    }
  ]
